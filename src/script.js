...
closedModalBtn.addEventListener("click", function(event){
    cartModal.style.display = "none"
})
...
menu.addEventListener("click", function(event){
    ...
    if(parentButton){
        ...
        const valor = parseFloat(parentButton.getAttribute("data-price"))
...
function addToCart(name, price){
    ...
    if(existingItems){
        //Se o item ja existe, aumenta apenas a quantidade mais 1
...
function updateCartModal(){
    ...
    countCounter.innerHTML = cart.length;
}
